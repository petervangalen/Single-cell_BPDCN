...
# Select mutations to show. See also the email thread "Bar plot" around 220918
...
#Pt15 "U2AF1.S34F" - very highly expressed, UMAP suggests false positives by soup RNA or doublets
...
# Visualize barplots of each mutation separately in normal and malignant cells --------------------

# Also start a list for the next section
split_ls <- vector(mode = "list")

# Visualize plots
pdf("11.3.1_Split_by_mutation.pdf", width = 10, height = 6)
...
pdf("11.3.2_Split_combined.pdf", width = 8, height = 16)
