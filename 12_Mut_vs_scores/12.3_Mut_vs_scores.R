...
pdf("12.3.1_Scores-vs-Muts.pdf", width = 20, height = 20)
metadata_tib %>%
...
# Visualize
pdf(paste0("12.3.2_Scores-vs-Mut_type_ColorVersion", color_version, ".pdf"), width = 16, height = 4)
...
pdf("12.3.3_Pt14Dx_ETV6.R369W.pdf", width = 5, height = 5)
