...
MalignantCalls_tib <- read_tsv("9.4_MalignantCalls_Final.txt")
...
write_tsv(file = "9.5_Premalignant-vs-Healthy_pDC_DEG.txt", markerGenes_tib)
...
pdf("9.5_Premalignant_pDCs.pdf", width = 12, height = 4)
