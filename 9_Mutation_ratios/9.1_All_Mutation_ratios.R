...
write.table(mut_counts.df, file = paste0("transcript_counts/", sample, "_mut_counts.txt"))
write.table(wt_counts.df, file = paste0("transcript_counts/", sample, "_wt_counts.txt"))
write.table(counts.df, file = paste0("transcript_counts/", sample, "_counts.txt"))
